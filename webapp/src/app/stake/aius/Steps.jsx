...
export default function Steps(){
    return (
           <div className="bg-white-background h-[270px] stake-box-shadow rounded-2xl p-8 box-border">
                <div className="mt-2 flex r gap-4">
                     <div className="flex flex-col items-center">
                        ...
                        <div>
                            <div>
                                <p className="text-original- font-Sequel-Sans-Light-Body">
                                Select the amount of AIUS you want to lock.
                                </p>
                            </div>
                            <div className="mt-[26px]">
                                <p className="text-original-black font-Sequel-Sans-Light-Body">
