                ...
                <Link href={"https://arbius.ai/generate"} target="_blank">
                  <div>
                    ...
                    >
                      ...
                      <div className="font-Sequel-Sans-Medium-Head mb-1 relative z-10 text-original-white  text-[13px] lg:text-[100%]">
                        Try now
                      </div>
                      <Image
                        src={right_arrow}
                ...
                <Link href={"https://arbius.ai/paper.pdf"} target="_blank">
                  <div>
                    ...
                    >
                      ...
                      <div className="font-Sequel-Sans-Medium-Head mb-1 relative z-10 text-[13px] lg:text-[100%]">
                        Read Whitepaper
                      </div>
                    </button>
                  </div>
