                        ...
                        <Fade direction="up" triggerOnce={true}>
                            <div className="flex items-center mt-[30px] gap-[20px]">
                                <div>
                                    ...
                                    <button type="button" className="  relative group bg-black py-2 px-5 lg:px-8 rounded-full flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <button type="button" className=" hover:text-[white] hover:border-[transparent] text-original-black border-[1px] relative group bg-transparent py-2 px-5 lg:px-8 rounded-full flex items-center gap-3">
