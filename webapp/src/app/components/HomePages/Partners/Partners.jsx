    ...
    return (
        <div className="CollaboratorsMarquee">
            <div className="ArbiusPartners flex items-center justify-around p-[80px_0] MarqueeContainer">
                ...
                <div className="px-5 lg:px-0"><Image src={arbitrum} alt="" /></div>
                <div className="px-5 lg:px-0"><Image src={labs} alt="" /></div>
                <div className="px-5 lg:px-0"><Image src={gysr} alt="" /></div>
                <div className="px-5 lg:px-0"><Image src={poloniex} alt="" /></div>
                <div className="px-5 lg:px-0"><Image src={coinex} alt="" /></div>
                <div className="px-5 lg:px-0"><Image src={exabits} alt="" /></div>
