...
export default function GeneratePage() {
  ...
  const [modelFee, setModelFee] = useState(
    ethers.BigNumber.from(Config.models.kandinsky2.params.fee)
  );
            ...
            <div className='mt-10 grid sm:grid-cols-1 md:grid-cols-2'>
              ...
              <div>
                <div className='mt-6 gap-4 lg:mx-12'>
                  <div className='bg-white border-slate-200 flex flex-row justify-between rounded-md border border-hidden dark:bg-transparent sm:p-1 md:p-4 lg:border-solid'>
                    <div className=''>
