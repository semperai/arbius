...
export default function GetLPButton() {
  return (
    <div>
      <a
        href={`https://app.sushi.com/legacy/add/ETH/${Config.baseTokenAddress}?chainId=42170`}
        target="_blank"
      >
        <button
        ...
        >
          Get LP <ArrowTopRightOnSquareIcon className="ml-1 inline h-4 w-4 align-top -translate-y-0.5" aria-hidden="true" />
        </button>
      </a>
    </div>
  );
