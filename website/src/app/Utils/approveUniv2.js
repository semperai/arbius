...
const GYSR_STAKING_CONTRACT_ADDRESS =
  '0x2f8152bbA263Cb1bCF73b0Cb1E6CB4cA40b9F6d7';
...
export const approveUNIV2 = async (amt) => {
  if (window.ethereum) {
    ...
    try {
      ...
      const result = await uniV2Contract.methods
        .approve(GYSR_STAKING_CONTRACT_ADDRESS, amount)
        .send({ from: account });
