...
export default function Community(){
    ...
    return (
        <div className="py-16 lg:py-24 bg-[url('../app/assets/images/buy_background.png')] bg-no-repeat bg-cover">
            <div className="lg:w-section-width w-mobile-section-width mx-auto max-w-center-width bg-white-background py-10 box-border">
                <div>
                    <div>
                        <div className="mb-6">
                            <h2 className="lato-bold lg:text-header text-mobile-header text-black-text fade-container lg:leading-none leading-[60px] ">
                                <Fade delay={0.1} cascade damping={0.05} triggerOnce={true}> 
                                   dApps & Community
                                </Fade>
                            </h2>
                            <h2 className="lato-bold lg:text-header text-mobile-header text-black-text flex items-center gap-4 fade-container lg:mt-2">
