      ...
      <div className="py-16 lg:py-24 lg:p-0 w-mobile-section-width lg:w-section-width m-[auto] max-w-center-width">
        <div className="w-[100%] xl:w-[65%]">
          <Fade direction="up" triggerOnce={true}>
            <div className="text-[16px] lg:text-[12px] mb-2 lg:mb-0 Gradient-transparent-text bg-background-gradient-txt 2xl:text-para">
              Welcome to Arbius!
            </div>
          </Fade>
          ...
          <div>
            <Fade direction="up" triggerOnce={true}>
              <div className="text-para lato-regular text-subtext-one header-para 2xl:text-large-description">
                ...
                <Link href={"https://arbius.ai/generate"} target="_blank">
                  <div>
                    ...
                    >
                      ...
                      <div className="lato-bold relative z-10 text-original-white lg:text-[100%] 2xl:text-large-description">
                        Try now
                      </div>
                      <Image
                        src={right_arrow}
                ...
                <Link href={"https://arbius.ai/paper.pdf"} target="_blank">
                  <div>
                    ...
                    >
                      ...
                      <div className="lato-regular relative z-10 lg:text-[100%] 2xl:text-large-description">
                        Read Whitepaper
                      </div>
                    </button>
                  </div>
