        ...
        <>
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 w-mobile-section-width lg:w-[90%] m-[auto]">
                ...
                <div className="rounded-2xl p-6 lg:p-10 h-[auto]  lg:h-[auto]  bg-white-background stake-card">
                    ...
                    <div className="mt-6 shadow-none p-6 rounded-[25px] h-[150px] transition-all hover:shadow-stats hover:cursor-pointer bg-[#F9F6FF]" id="totalStaked">
                        <div className="flex justify-start items-baseline" >
                            <h1 className="text-[25px] xl:text-[30px] font-medium text-purple-text">{parseFloat(data.pool.staked).toFixed(2) }</h1>
                    ...
                    <div className="flex justify-start gap-[40px] mt-4">
                        <div >
                            <h1 className="text-[20px] text-purple-text">${parseFloat(data.pool.tvl/1000000).toFixed(2) }M</h1>
                ...
                <div className="rounded-2xl p-6 lg:p-10 h-[auto] lg:h-[auto] bg-white-background stake-card">
                    ...
                    <div className="mt-6 h-[150px]">
                        <div className="flex justify-start items-baseline">
                            <h1 className="text-[25px] lg:text-[30px] font-medium">{parseFloat(data.pool.apr).toFixed(2)}%</h1>
                        </div>
                        <h1 className="text-[8px] lg:text-[13px] font-medium">apr</h1>
                    </div>

                    <hr className="opacity-70 mt-6" />

                    <div className="bg-[#F9F6FF] h-[300px] rounded-[25px]   p-6 mt-6">
                        <div className="">
                            <div className="flex justify-start items-baseline">
                                <h1 className="text-[20px] lg:text-[20px] font-medium">{parseFloat(data?.pool?.funded/1000).toFixed(2)}k&nbsp;</h1>
                                <p className="text-[18px] ">AIUS</p>
                            </div>
                            <h1 className="text-[8px] lg:text-[13px] font-medium">funded</h1>
                        </div>
                        <div className="flex justify-start gap-[40px] mt-6 pb-8">
                            <div >
                                <h1 className="text-[20px]">{parseFloat((data.pool.funded/1000-data.pool.distributed/1000).toFixed(2))}k AIUS</h1>
                                <h2 className="text-[18px] font-medium">Remaining</h2>
                            </div>
                            <div >
                                <h1 className="text-[20px]">{parseFloat(data.pool.distributed/1000).toFixed(2)}k AIUS</h1>
                                <h2 className="text-[18px] font-medium">Distributed</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div className="rounded-2xl p-6 lg:p-10 h-[auto] lg:h-[auto] bg-white-background stake-card">
                    ...
                    <div className="mt-6 shadow-none p-6 rounded-[25px] h-[150px] transition-all hover:shadow-stats hover:cursor-pointer bg-[#F9F6FF]" id="remaningDyays">
                        <div className="flex justify-start items-baseline">
                            <h1 className="text-[25px] lg:text-[30px] font-medium text-purple-text" > {daysBetweenCurrentAndPassedDate(epochToDate(data.pool.end))}&nbsp;</h1>
                            <HintBox
