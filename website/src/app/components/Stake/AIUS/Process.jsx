...
export default function Process() {
    return (
        <div>
            <div className="bg-white-background 2xl:h-[242px] lg:h-[246px] h-auto stake-box-shadow rounded-2xl px-8 2xl:pt-8 lg:pt-10 pb-8  pt-8 box-border text-original-black flex items-center">
                <div>
                    <div>
