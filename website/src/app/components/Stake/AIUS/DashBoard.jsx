...
function DashBoard() {
    return (
        <div className='xl:w-section-width w-mobile-section-width text-black-text mx-auto max-w-center-width py-16'>
                        ...
                        <div className='flex justify-start gap-12 mt-6 mb-10'>
                            ...
                            <div className='flex flex-col gap-6 justify-center items-start'>
                                ...
                                <div>
                                    ...
                                    <div className='flex justify-start items-center gap-2'> <h2 className='text-[16px] font-semibold'>+ 41.12%</h2>
                                        <Image src={gysr_logo_wallet} width={18} height={18} />
                                    </div>
