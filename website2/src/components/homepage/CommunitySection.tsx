...
import swapMarketBackground from '@/app/assets/images/swap_market_background.png'
...
const platforms = [
  {
    ...
    backgroundImage: swapMarketBackground.src,
  },
]
...
export function CommunitySection() {
  return (
    <div className="bg-[linear-gradient(180deg,#fbfbfb_70.03%,#4a28ff_330.54%)] py-16 lg:py-24">
      <div className="mx-auto box-border w-[90%] max-w-[2000px] py-10 lg:w-[80%]">
        <div className="mb-6">
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row md:gap-0 2xl:justify-start 2xl:gap-[12%]">
          {platforms.map((platform) => (
            <div
              key={platform.id}
              className="relative h-auto w-[95%] rounded-3xl bg-cover bg-center bg-no-repeat p-6 md:h-[250px] md:w-[45%] 2xl:w-[30%]"
            ...
            >
              ...
              <div className="mt-6">
                ...
                >
                  <button
                    type="button"
                    className="group relative flex items-center gap-3 rounded-full bg-black px-8 py-2 cursor-pointer"
                  >
