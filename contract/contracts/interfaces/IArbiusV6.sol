...
interface IArbiusV6 {
    ...
    // ============ Mappings ============
    // Note: These return individual fields, not memory structs, to match the public mapping behavior

    // models mapping - returns individual fields
    function models(bytes32 model) external view returns (
        uint256 fee,
        address addr,
        uint256 rate,
        bytes memory cid
    ...
    // validators mapping - returns individual fields  
    function validators(address addr) external view returns (
        uint256 staked,
        uint256 since,
        address validatorAddr
    );

    // pendingValidatorWithdrawRequests mapping - returns individual fields
    ...
    // tasks mapping - returns individual fields
    ...
    // solutions mapping - returns individual fields
    function solutions(bytes32 taskid) external view returns (
        address validator,
        uint64 blocktime,
        bool claimed,
        bytes memory cid
    ...
    // contestations mapping - returns individual fields
    function contestations(bytes32 taskid) external view returns (
        address validator,
        uint64 blocktime,
