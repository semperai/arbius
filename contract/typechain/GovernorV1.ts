...
export interface GovernorV1Interface extends utils.Interface {
  functions: {
    ...
    "descriptionCids(uint256)": FunctionFragment;
    "descriptionHashes(uint256)": FunctionFragment;
    ...
    "proposalsCreated(uint256)": FunctionFragment;
    "proposalsCreatedLength()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "descriptionCids",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "descriptionHashes",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposalsCreated",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "proposalsCreatedLength",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface GovernorV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorV1Interface;
  ...
  functions: {
    ...
    proposalsCreatedLength(overrides?: CallOverrides): Promise<[BigNumber]>;
