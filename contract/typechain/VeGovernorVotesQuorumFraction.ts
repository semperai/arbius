...
export interface VeGovernorVotesQuorumFractionInterface
...
export interface VeGovernorVotesQuorumFraction extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeGovernorVotesQuorumFractionInterface;
