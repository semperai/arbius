...
export interface V2EngineV5Interface extends utils.Interface {
  functions: {
...
export interface V2EngineV5 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2EngineV5Interface;
  ...
  callStatic: {
    ...
    setVoter(voter_: string, overrides?: CallOverrides): Promise<void>;
