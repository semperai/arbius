...
export interface V2_EngineV3_WithdrawInterface extends utils.Interface {
  functions: {
...
export interface V2_EngineV3_Withdraw extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2_EngineV3_WithdrawInterface;
