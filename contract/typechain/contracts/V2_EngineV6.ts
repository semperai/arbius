...
export interface V2_EngineV6Interface extends utils.Interface {
  functions: {
    ...
    "submitSolutionMinerAllowList(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "submitSolutionMinerAllowList",
    values: [PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
...
export interface V2_EngineV6 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2_EngineV6Interface;
  ...
  functions: {
    ...
    submitSolutionMinerAllowList(
      arg0: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<[boolean] & { requiresAllowList: boolean }>;
