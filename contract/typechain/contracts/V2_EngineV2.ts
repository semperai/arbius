...
export interface V2_EngineV2Interface extends utils.Interface {
  functions: {
...
export interface SolutionStakeAmountChangedEventObject {
  amount: BigNumber;
}
export type SolutionStakeAmountChangedEvent = TypedEvent<
  [BigNumber],
  SolutionStakeAmountChangedEventObject
>;
...
export interface V2_EngineV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: V2_EngineV2Interface;
