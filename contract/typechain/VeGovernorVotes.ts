...
export interface VeGovernorVotesInterface extends utils.Interface {
  functions: {
...
export interface VeGovernorVotes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VeGovernorVotesInterface;
