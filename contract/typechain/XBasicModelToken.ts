...
export interface XBasicModelTokenInterface extends utils.Interface {
  functions: {
...
export interface XBasicModelToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XBasicModelTokenInterface;
