...
To find charts of the emission schedule, please refer to the Arbius's [whitepaper](https://arbius.ai/paper.pdf).
...
9% of all newly created Arbius is sent to a contract which distributes the Arbius to liquidity providers. This encourages sufficient liquidity to allow miners to enter and exit the network easily.
