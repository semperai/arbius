...
<Note>
  A curated group of trusted validators who specialize in detecting invalid solutions.
</Note>
...
<Note>
  Model creators can restrict who can submit solutions to their models.
</Note>
...
<Note>
  Rewards automatically compound into validator stakes instead of being transferred.
</Note>
...
<Note>
  Contract owner can set custom treasury fee percentages for specific models (admin-only feature).
</Note>
