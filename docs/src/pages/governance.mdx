...
<Note>Governance will be deployed on the Arbius Protocol in the future once there is sufficient coin distribution. This document describes the future governance system.</Note>
...
Users can delegate their voting rights to another address [on the governance page](https://arbius.ai/governance). You can also of course delegate to yourself to participate in voting.
...
Users have `3` days to vote on a proposal. We use [Bravo](https://docs.compound.finance/v2/governance/#governor-bravo) style voting which allows for "For", "Against", and "Abstain" choices.
