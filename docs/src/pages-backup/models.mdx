...
<Note>
  **New in V6**: Model creators can restrict who can submit solutions to their models. Perfect for quality control during launch phases or private deployments.
</Note>
...
<Row>
  <Col>
    <Note>
      **New in V6**: Register a model with an allow list to restrict who can submit solutions.
    </Note>
...
<Row>
  <Col>
    <Note>
      **Model owner or contract owner only**: These functions can only be called by the model's registered address or the contract owner.
    </Note>
