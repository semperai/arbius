...
<Note>
  **New in V6**: You can register models with allow lists to control who can submit solutions. This is perfect for quality control during launch phases or private deployments.
</Note>
